...
public class DataController {
    ...
    public R columnSpecialYearCountryAndAvgData(String  aIndex,String special,String year){
        ...
        List allIndex = dataService.allIndex();
        //地图的数据
        List columnSpecialYearCountryAndAvgDataList = dataService.columnCountrySpecialYearAndAvgData(aIndex,special,year);
        return R.ok().put("data", columnSpecialYearCountryAndAvgDataList).put("allYear",allYear).put("allSpecial",allSpecial).put("allIndex",allIndex);
    }
    ...
    public R CityAndAvgData(String  aIndex,String provinceEn){
        ...
        List allIndex = dataService.allIndex();
        //地图的数据
        List cityAndAvgDataList = dataService.columnCityAndAvgData(aIndex,provinceEn);
        return R.ok().put("data", cityAndAvgDataList).put("allYear",allYear).put("allSpecial",allSpecial).put("allIndex",allIndex);
    }
